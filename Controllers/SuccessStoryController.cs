...
namespace LoveNottiesV2.Controllers
{
    public class SuccessStoryController : Controller
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            if (_IBlobService.DoesBlobExists(successStory.SuccessStoryImageID, BlobContainer.blogimages).Result == true)
            {
                await _IBlobService.DeleteFromBlob(successStory.SuccessStoryImageID, BlobContainer.blogimages);
            }
